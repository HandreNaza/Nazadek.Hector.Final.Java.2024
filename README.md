...
## Sobre la Aplicación
Bueno en resumen la aplicacion se trata de un sistema para gestionar vuelos VuelosComerciales de Cabotaje y Sanitarios.
la misma permite agendr nuevos vuelos con un ID unico auto Incremntal con sus datos como numero de vuelo, nombre de aerolinea y fechas.
